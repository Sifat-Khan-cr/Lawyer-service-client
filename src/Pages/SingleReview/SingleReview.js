...
const SingleReview = ({ reviews }) => {
    const { userName, email, review, photo } = reviews;
    return (
        <div>
            ...
            <figure class="mx-auto max-w-screen-md text-center">
                ...
                <blockquote>
                    <p class="text-2xl italic font-medium text-gray-900 dark:text-white">{review}</p>
                </blockquote>
                <figcaption class="flex justify-center items-center mt-6 space-x-3">
                    <img class="w-6 h-6 rounded-full" src={photo} alt="user" />
                    <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                        <cite class="pr-3 font-medium text-gray-900 dark:text-white">{userName}</cite>
                    </div>
                </figcaption>
            </figure>
